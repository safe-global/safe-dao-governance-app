  ...
  return (
    <Grid container px={6} pt={5} pb={4}>
      ...
      <Typography mb={3}>
        ...
        <br />- that you are responsible for any tax obligations arising out of the interaction with this app.
        <br />
        <br />
        None of the information available on this app, or made otherwise available to you in relation to its use,
        constitutes any legal, tax, financial or other advice. Where in doubt as to the action you should take, please
