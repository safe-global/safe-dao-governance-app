...
// Taken from https://github.com/rainbow-me/rainbowkit/blob/main/site/lib/useCoolMode.ts
export const useCoolMode = (imageUrl: string, disabled?: boolean, ignoreCoolModeDocsDemo?: boolean) => {
  const ref = useRef<HTMLElement>(null)
  const resolvedImageUrl = imageUrl

  useEffect(() => {
    if (ref.current && resolvedImageUrl) {
      return makeElementCool(ref.current, resolvedImageUrl, disabled || false, ignoreCoolModeDocsDemo || false)
    }
